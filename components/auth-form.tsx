...
export default function AuthForm({ mode = 'sign-in' }: { mode?: 'sign-in' | 'sign-up' }) {
  ...
  return <div className="w-full max-w-md rounded-3xl border border-slate-200 bg-white p-8 shadow-xl shadow-slate-900/5 sm:p-10">
    <div className="mb-8 flex items-center gap-3"><div className="flex size-11 items-center justify-center rounded-xl bg-[#20b8ae] text-white"><Sparkles className="size-5" /></div><div><p className="text-lg font-bold tracking-tight text-[#12243d]">NEXUS<span className="text-[#20b8ae]">.OS</span></p><p className="text-[10px] uppercase tracking-[0.18em] text-slate-400">Business suite</p></div></div>
